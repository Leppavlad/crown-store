      ...
      {!cartItems.length ? (
        ...
        <>
          <div className="checkout__header">
            <div className="checkout__block checkout__block_large">Produce</div>
            ...
            <div className="checkout__block checkout__block_medium">Price</div>
            <div className="checkout__block checkout__block_small">Remove</div>
          </div>
